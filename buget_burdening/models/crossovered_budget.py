...
class Budget(models.Model):
    ...
    abs_practical_amount = fields.Monetary(string='ABS Practical Amount', group_operator='sum',
                                           help="Amount really earned/spent.")
    abs_theoritical_amount = fields.Monetary(string='ABS Theoretical Amount',  group_operator='sum',
